...
const FeaturedEventsCarousel = lazy(() => import("../components/FeaturedEventsCarousel"));
const EventJourneyCarousel = lazy(() => import("../components/EventJourneyCarousel"));
...
const VideoBackgroundSection = lazy(() => import("../components/VideoBackgroundSection"));
...
const LoadingSkeleton = ({ height = 200 }: { height?: number }) => (
  <div style={{ height, background: "#f0f0f0", margin: "20px 0", borderRadius: "8px" }} />
);
