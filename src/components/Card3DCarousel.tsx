...
const Card3DCarousel: React.FC = () => {
  ...
  // Calculate 3D positioning for Framer Motion
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Experience our most spectacular celebrations in an immersive 3D
            showcase
          </p>
        </motion.div>
        ...
        >
          ...
          <button
            onClick={prevCard}
            className="absolute left-8 top-1/2 transform -translate-y-1/2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white p-4 rounded-full z-20 border border-white/20"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button
            onClick={nextCard}
            className="absolute right-8 top-1/2 transform -translate-y-1/2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white p-4 rounded-full z-20 border border-white/20"
          >
