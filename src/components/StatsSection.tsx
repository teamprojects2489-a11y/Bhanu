...
const StatsSection: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 text-white relative overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div
                className={`bg-gradient-to-br ${stat.color} p-6 rounded-2xl shadow-xl transform transition-all duration-300 group-hover:shadow-2xl`}
              >
                <div className="text-center text-white">
                  <div className="mb-4 flex justify-center group-hover:scale-110 transition-transform duration-300">
                    {stat.icon}
                  </div>
                  <h3 className="stat-number text-2xl md:text-3xl font-bold mb-2">
                    {stat.number}
                  </h3>
