...
const DecorationsSection: React.FC = () => {
  const decorations = [
    { name: "Balloons", icon: "🎈", color: "from-red-400 to-pink-500" },
    { name: "Flower Decorations", icon: "🌸", color: "from-pink-400 to-rose-500" },
    { name: "Ribbons", icon: "🎀", color: "from-purple-400 to-indigo-500" },
    { name: "Lights", icon: "💡", color: "from-yellow-400 to-orange-500" },
    { name: "Stage Backdrop", icon: "🎭", color: "from-blue-400 to-cyan-500" },
    { name: "Entry Arches", icon: "🌉", color: "from-green-400 to-teal-500" }
  ];
