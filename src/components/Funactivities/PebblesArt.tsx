...
const PebblesArt: React.FC = () => {
  ...
  return (
    <section className="py-40 min-h-screen bg-gradient-to-br from-emerald-100 via-sky-100 to-indigo-100">
      <div className="container mx-auto px-4 relative">
        ...
        <motion.h2
          className="text-4xl md:text-5xl font-extrabold text-center text-emerald-700 mb-4 tracking-tight drop-shadow relative z-10"
