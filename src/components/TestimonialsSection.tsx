  ...
  const testimonials = [
    {
      ...
      name: "Priya Sharma",
      review:
        "SB EVENTS made our daughter's birthday absolutely magical! The decorations were stunning and the kids had so much fun with all the activities.",
      rating: 5,
    ...
    },
    {
      ...
      name: "Rajesh Kumar",
      review:
        "Professional service from start to finish. Our wedding ceremony was beautifully organized and all guests were thoroughly impressed.",
      rating: 5,
    ...
    },
    {
      ...
      name: "Anita Patel",
      review:
        "The team is creative, punctual, and professional. They transformed our corporate event space into something truly spectacular!",
      rating: 5,
    ...
    },
    {
      ...
      name: "Chandra Giri",
      review:
        "Excellent attention to detail and wonderful service. Our family function was memorable thanks to their creative decorations and planning.",
      rating: 5,
    ...
    },
    {
      ...
      name: "Sunita Gupta",
      review:
        "Amazing experience! The dance performances were outstanding and the kids' activities kept everyone engaged throughout the event.",
      rating: 5,
